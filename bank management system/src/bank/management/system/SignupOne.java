...
public class SignupOne extends JFrame implements ActionListener {
    ...
    long random;
    JTextField nameTextField, fnameTextField, mnumberTextField, emailTextField, addressTextField, cityTextField, stateTextField, pincodeTextField;
    JButton next;
    ...
    SignupOne() {
        ...
        JLabel mnumber = new JLabel("Mobile Number:");
        mnumber.setFont(new Font("Raleway", Font.BOLD, 20));
        mnumber.setBounds(100, 340, 200, 30);
        add(mnumber);
        
        mnumberTextField = new JTextField();
        mnumberTextField.setFont(new Font("Raleway", Font.BOLD, 14));
        mnumberTextField.setBounds(300, 340, 400, 30);
        add(mnumberTextField);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if (name.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "mnumber is Required");
                ...
                Conn c = new Conn();
                String query = "insert into signup values('" + formno + "', '" + name + "', '" + fname + "', '" + dob + "', '" + gender + "', '" + mnumber + "','" + email + "','" + marital + "','" + address + "','" + city + "','" + state + "','" + pincode + "')";
